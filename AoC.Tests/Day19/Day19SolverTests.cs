...
0,7,-8".NormalizeLineEndings());
    ...
    private const string OverlappingBeaconsExample = @"--- scanner 0 ---
404,-588,-901
528,-643,409
-838,591,734
390,-675,-793
...
30,-46,-14";
    ...
    {
        var scanner0 = Scanner.ParseInputToScanners(OverlappingBeaconsExample).ElementAt(0);
        var scanner1 = Scanner.ParseInputToScanners(OverlappingBeaconsExample).ElementAt(1);
    ...
    {
        var scanner1 = Scanner.ParseInputToScanners(OverlappingBeaconsExample).ElementAt(1);
        var scanner4 = Scanner.ParseInputToScanners(OverlappingBeaconsExample).ElementAt(4);
