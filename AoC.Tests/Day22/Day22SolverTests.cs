...
off x=-93533..-4276,y=-16170..68771,z=-104985..-24507";
    ...
    [Test]
    public void BoundingBox_Intersect_CubesThatDoNotOverlap_ShouldReturnZeroIntersectionArea()
    {
        var rebootSteps = ParseInput(ExampleInputLarge);

        // ACT
        var boxesIntersect = BoundingBox.Intersect(rebootSteps.First().Bounds, rebootSteps.Last().Bounds, out _);
    ...
    [Test]
    public void BoundingBox_Intersect_CubesOutOfBounds_ShouldReturnZeroIntersectionArea()
    {
        var rebootSteps = ParseInput(ExampleInputLarge);

        // ACT
        var boxesIntersect = BoundingBox.Intersect(
    ...
    [Test]
    public void BoundingBox_Intersect_CubesThatExactlyOverlap_ShouldReturnExactlySameArea()
    {
        var rebootSteps = ParseInput(ExampleInputLarge);
        ...
        // ACT
        var boxesIntersect = BoundingBox.Intersect(cube, cube, out var intersection);
    ...
    [Test]
    public void BoundingBox_Intersect_CubesThatPartiallyOverlap_ShouldReturnAreaOfOverlap_Test1()
    {
        ...
        // ACT
        var boxesIntersect = BoundingBox.Intersect(cube1, cube2, out _);
    ...
    [Test]
    public void BoundingBox_Intersect_CubesThatPartiallyOverlap_ShouldReturnAreaOfOverlap_Test2()
    {
        var cube1 = new BoundingBox(new Vector3(0, 0, 0), new Vector3(10, 10, 10));
        var cube2 = new BoundingBox(new Vector3(1, 1, 1), new Vector3(11, 11, 11));

        // ACT
        var boxesIntersect = BoundingBox.Intersect(cube1, cube2, out var intersection);
    ...
    [Test]
    public void BoundingBox_Intersect_SmallerCubesTotallyWithinLargerCube_ShouldReturnSmallerCubeAsIntersection()
    {
        ...
        // ACT
        var boxesIntersect = BoundingBox.Intersect(smallCube, largeCube, out var intersection);
    ...
    public void Part2Example()
    {
        ...
        // ASSERT
        part2ExampleResult.Should().Be(2758514936282225);
    }

    [Test]
    [LongRunningTest("~1.2 seconds")]
    public void Part2ReTest()
    {
        ...
        // ASSERT
        part2Result.Should().Be(1263946820845866);
    }
}
